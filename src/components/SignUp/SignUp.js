...
function SignUpForm({toggleSignup,handleSignupModalShowHide,handleLoginModalShowHide}) {
                        ...
                        <Container>
                                <Row>    
                                        ...
                                        <Col xs={6} lg={6}>
                                            ...
                                            <input name="name" type="text" placeholder="Enter Your Name" className="emailInput"
                                                value={values.name}
                                    ...
                                    { values.role==='doctor' &&
                                        <>
                                            <Col xs={6} lg={6}>
                                                <div className="InputContainer">
                                                <input name="degree" type="text" placeholder="Enter Your Degree" className="emailInput"
                                                    value={values.degree}
                                                    onChange={handleChange}
                                                />
                                                </div>
                                            ...
                                            <Col xs={6} lg={6}>
                                                <div className="InputContainer">
                                                <input name="experience" type="text" placeholder="Enter Your Experience" className="emailInput"
                                            ...
                                            <Col xs={6} lg={6}>
                                                <div className="InputContainer">
                                                <input name="registrationNumber" type="text" placeholder="Your Registration No" className="emailInput"
                                                ...
                                                <div className="invalid-feedback">
                                                        {errors.registrationNumber && (
                                                            <p className="help is-danger">{errors.registrationNumber}</p>
                                                        )}
                                            </div>
                                            </Col>
                                            <Col xs={6} lg={6}>
                                                <div className="InputContainer">
                                                <input name="consultancyFee" type="text" placeholder="Your Consultancy Fee" className="emailInput"
                                                ...
                                                <div className="invalid-feedback">
                                                        {errors.consultancyFee && (
                                                            <p className="help is-danger">{errors.consultancyFee}</p>
                                                        )}
                                            </div>
                                            </Col>
                                        </>
                                        ...
                                        <Col xs={6} lg={6}>
                                            <div className="InputContainer">
                                            <input name="password" type="text" placeholder="Enter Your Password" className="emailInput"
                                        ...
                                        <Col xs={6} lg={6}>
                                            <div className="InputContainer">
                                            <input name="confirmPassword" type="text" placeholder="Confirm Your Password" className="emailInput"
                            ...
                            <div className="invalid-feedback">
                             ...
                             <div className="valid-feedback">
                                {msg && (
                                    <p className="help is-success">{msg}</p>
                                )}
                             </div>
                                        ...
                                        <div className="ActionContainer">
                                            <button className="ContinueButton" type="submit"> Sign Up</button>
                                        </div>
                                        ...
                                        seterr("");
                                            ...
                                            <div className="ContinueButtonBlue">Login
