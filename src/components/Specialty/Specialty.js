...
const [data,setData]=useState({})
  ...
  return ( 
          ...
          <div className="container">
            ...
            <div className="col">
              <h1 className="name">{data.type}</h1>
              
              <p>About</p>
              <p className="about_text"> {data.about}</p>

              <div className="doctors_container">
                <div className="doctors_search">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                <path fill="#000" fillRule="evenodd" d="M6.732 12.229c-3.146 0-5.696-2.506-5.696-5.602 0-3.096 2.55-5.607 5.696-5.607s5.696 2.511 5.696 5.607-2.55 5.602-5.696 5.602zm9.116 2.9l-4.13-4.066a6.526 6.526 0 0 0 1.745-4.436C13.463 2.966 10.45 0 6.732 0S0 2.966 0 6.627c0 3.656 3.014 6.622 6.732 6.622 1.606 0 3.08-.555 4.237-1.48l4.147 4.081c.202.2.53.2.732 0a.503.503 0 0 0 0-.72z" opacity=".4"/>
                                </svg>
                            </span>
                          <div id="care_doctor_search_input" className="care-search-input-container ">
                            <input placeholder="search doctors " type="text"/>
                          </div>
                </div>
                                 ...
                                 <div className="card-body">
                                   <div className="row">
                                       ...
                                       <img className="doc_profile_image" src={doc} alt='spl_img' />
                                         ...
                                         <h5 className="card-title">{doctor.name} <span className="fee"> ₹ {doctor.fee} </span></h5>
                                         <p className="card-text">{doctor.experience} | {doctor.degree }</p>
                                         ...
                                         <p className="card-text"> 
                                         <span>
                                         <svg width="13px" height="15px" viewBox="0 0 10 11" version="1.1">
                                              <g id="Doctor-Sub-Speciality" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                                    <g id="Speciality-page_experiment-5.1-Copy-5" transform="translate(-34.000000, -1031.000000)" fillRule="nonzero">
                                                        <g id="Group-4" transform="translate(34.000000, 1031.000000)">
                                                            <path d="M2.5,1.9 C1.6163444,1.9 0.9,2.6163444 0.9,3.5 L0.9,8.5 C0.9,9.3836556 1.6163444,10.1 2.5,10.1 L7.5,10.1 C8.3836556,10.1 9.1,9.3836556 9.1,8.5 L9.1,3.5 C9.1,2.6163444 8.3836556,1.9 7.5,1.9 L2.5,1.9 Z M2.5,0 L2.5,1 L2.5,1 L4.5,0.999 L4.5,0 L5.5,0 L5.5,0.999 L7.5,1 L7.5,0 L8.5,0 L8.50083003,1.20838468 C9.38333908,1.59435237 10,2.47516175 10,3.5 L10,8.5 C10,9.88071187 8.88071187,11 7.5,11 L2.5,11 C1.11928813,11 0,9.88071187 0,8.5 L0,3.5 C0,2.47477282 0.617129067,1.59368385 1.50017484,1.20794546 L1.5,0 L2.5,0 Z" id="Combined-Shape-Copy-61" fill="#262626"></path>
                                         ...
                                         Next Available Slot {doctor.nextSlot}</p>
                                         <button  className="btn  bookSlot-btn">Book Appointment</button>
                                       </div>
                                   </div>
